...
INSERT INTO requilib_website.img (path, nome, descricao, entidade, entidade_id) VALUES ('img/equipa/DF/1.jpg', 'DF', '1', 'funcionario', (SELECT id FROM requilib_website.funcionario WHERE nome = 'Diogo Ferreira'));
